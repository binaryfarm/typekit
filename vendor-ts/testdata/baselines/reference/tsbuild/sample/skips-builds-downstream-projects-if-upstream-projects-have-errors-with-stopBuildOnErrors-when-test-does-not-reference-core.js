...
export function multiply(a: number, b: number) { return a * b; }multiply();
...
tsgo --b tests --verbose --stopBuildOnErrors
...
[96mcore/index.ts[0m:[93m3[0m:[93m65[0m - [91merror[0m[90m TS2554: [0mExpected 2 arguments, but got 0.
...
//// [/user/username/projects/sample1/core/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "./index.ts",
      "version": "4bf9c557eaa1c988144310898522b7b5-export const someString: string = \"HELLO WORLD\";\nexport function leftPad(s: string, n: number) { return s + n; }\nexport function multiply(a: number, b: number) { return a * b; }multiply();",
